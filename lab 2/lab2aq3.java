...
public class lab2aq3 {
    public static void main(String[] args) throws Exception {
        ...
        HotelRoom room3 = new HotelRoom(202,"single",0,90);
        ...
        System.out.println("the third room number is: " + room3.getRoomNum());
        System.out.println("the third room type is " + room3.getRoomType());

        if (room3.getOccupied() == 0) 
        {
            System.out.println("the third room is currently unoccupied");
        }
        else
        {
            System.out.println("the third room is currently occupied");
        }

        System.out.println("the third room has a rate of " + room3.getRate());
    }
}
